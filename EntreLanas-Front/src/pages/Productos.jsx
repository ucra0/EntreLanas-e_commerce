        ...
        <div className="row gap-4 gap-lg-0 align-items-start">
          ...
          <div className="col-lg-3 mb-4">
            <div className="card-premium sticky-sidebar" style={{ padding: '1.5rem' }}>
              <h5 className="logo-text mb-4 border-bottom pb-3 fs-4">
                <i className="fa-solid fa-sliders text-accent me-2"></i> Filtros
              </h5>
              ...
              <div className="mb-4">
                ...
                <input type="range" className="custom-range" name="precioMax"
                  min="0" max="100" value={filtros.precioMax} onChange={handleFiltroChange} />
              </div>
              ...
              <div className="mb-3">
                ...
                <select className="form-select border-0 bg-light shadow-none"
                  name="color" value={filtros.color} onChange={handleFiltroChange}>
                  <option value="">Todos los colores</option>
                  <option value="ROJO">Rojo</option><option value="AZUL">Azul</option>
                  <option value="AMARILLO">Amarillo</option><option value="VERDE">Verde</option>
                  <option value="ROSA">Rosa</option><option value="MORADO">Morado</option>
              ...
              {categoriaUrl === 'ROPA' && (
                <>
                  <div className="mb-3">
                    ...
                    <select className="form-select border-0 bg-light shadow-none"
                      name="talla" value={filtros.talla} onChange={handleFiltroChange}>
                      <option value="">Todas</option>
                      <option value="BEBE">Bebé</option><option value="NIÑO">Niño/a</option>
                  ...
                  <div className="mb-3">
                    ...
                    <select className="form-select border-0 bg-light shadow-none"
                      name="fibra" value={filtros.fibra} onChange={handleFiltroChange}>
                      <option value="">Todas</option>
                      <option value="LANA">Lana</option><option value="SEDA">Seda</option>
                      <option value="CACHEMIRA">Cachemira</option><option value="ALGODON">Algodón</option>
                      <option value="LINO">Lino</option><option value="BAMBU">Bambú</option>
                      <option value="NAILON">Nailon</option><option value="POLIESTER">Poliéster</option>
                    </select>
                  </div>
                </>
              )}
              ...
              {categoriaUrl === 'AMIGURUMI' && (
                <>
                  <div className="mb-3">
                    ...
                    <select className="form-select border-0 bg-light shadow-none"
                      name="tipo" value={filtros.tipo} onChange={handleFiltroChange}>
                  ...
                  <div className="mb-3">
                    ...
                    <select className="form-select border-0 bg-light shadow-none"
                      name="estilo" value={filtros.estilo} onChange={handleFiltroChange}>
                      <option value="">Todos</option>
            ...
            {productosFiltrados.length === 0 ? (
              <div className="text-center py-5 card-premium">
                ...
                <button onClick={limpiarFiltros}
                  className="btn bg-accent text-white rounded-pill px-4 mt-2 nav-link-hover">
