...
function Cart() {
  const { carrito, removeFromCart, updateQuantity, total } = useCart();
  const { user } = useAuth();
  ...
  // Navega directamente al checkout, el carrito se vacía solo tras confirmar el pedido
          ...
          <div className="col-lg-4">
            <div className="card-premium sticky-sidebar p-4">
              ...
              <div className="d-flex justify-content-between mb-3 text-muted">
                ...
                <span className="badge badge-pastel text-success bg-success bg-opacity-10 border-success">¡Gratis!</span>
              </div>
