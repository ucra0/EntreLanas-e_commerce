  ...
  return (
    ...
    >
      <div className="container py-2">
        ...
        {/* Logo */}
        <Link
          className="navbar-brand logo-text fs-3 text-dark d-flex align-items-center gap-2"
          to="/"
        >
          ...
          <ul className="navbar-nav ms-auto align-items-center fw-medium text-dark gap-3">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu shadow border-0 mt-2 border-radius-custom">
                <li>
                  <Link className="dropdown-item fw-bold nav-link-hover" to="/productos?categoria=ROPA">
                    Ropa
                  </Link>
                </li>
                <li>
                  <Link className="dropdown-item fw-bold nav-link-hover" to="/productos?categoria=MATERIAL">
                    Material
                  </Link>
                </li>
                <li>
                  <Link className="dropdown-item fw-bold nav-link-hover" to="/productos?categoria=AMIGURUMI">
                    Amigurumis
                  </Link>
                </li>
                <li><hr className="dropdown-divider" /></li>
                <li>
                  <Link className="dropdown-item nav-link-hover" to="/productos">
              ...
              <>
                ...
                <li className="nav-item">
                  <Link
                    ...
                    to="/mis-pedidos"
                  >
                    <i className="fa-solid fa-box-open text-accent me-2"></i> Mis pedidos
                  </Link>
                </li>
